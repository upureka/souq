                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="box-item">
                                ...
                                <form class="sign-form login-ajax" action="{{route('site.login')}}" method="post" onsubmit="false">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <input class="form-control" name="username" placeholder="اسم المستخدم او رقم الهاتف او البريد الالكترونى" type="text">
                                    </div><!--End form-group-->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="reset-new-user">
                                            <a href="reset-password.html" class="pull-left">
                                                هل نسيت كلمة المرور؟
                                            </a>
