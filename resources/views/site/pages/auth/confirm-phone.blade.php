                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="box-item">
                                ...
                                <form class="sign-form confirm-code-ajax" action="{{route('site.confirm',['username'=>$user->username])}}" method="post" onsubmit="false">
                                    {{csrf_field()}}
                                    <input type="hidden" value="{{$user->id}}" name="user_id"/>
                                    <div class="form-group">
                                        <input class="form-control" name="code" placeholder="رقم التاكيد" type="password">
                                    </div><!--End form-group-->
                                    <button class="custom-btn btn-block">تفعيل الحساب</button>
                                </form><!-- End Form -->
                            </div><!-- End Sign-Form -->
                        </div><!--End col-md-6-->
                    </div><!--End row-->
